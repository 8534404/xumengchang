    ...
    switch(info->event[i])
    {
      ...
      case EVENT_Motor_Speed:
        currentDataPoint.valueMotor_Speed = dataPointPtr->valueMotor_Speed;
				motorStatus(dataPointPtr->valueMotor_Speed);
...
void userHandle(void)
{
 ...
 /*
    ...
    currentDataPoint.valueLightintensity = ;//Add Sensor Data Collection
   ...
   static uint32_t thLastTimer = 0;
	if((gizGetTimerCount() - thLastTimer) > 2000)  
	{
	  ...
	  GPIO_LED4_RUN;
		currentDataPoint.valueHumidity = (4096 - (Get_Adc_Average(ADC_CHANNEL_1,20)))/40;
		currentDataPoint.valueLightintensity =4096 - (Get_Adc_Average(ADC_CHANNEL_0,20));
			if(ret != 0)
			{
...
void userInit(void)
{
    ...
    /** Warning !!! DataPoint Variables Init , Must Within The Data Range **/ 
      ...
      currentDataPoint.valueTemperature = 50;
      currentDataPoint.valueHumidity = 50;
      currentDataPoint.valueLightintensity = 50;
